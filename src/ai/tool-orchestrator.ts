...
export class ToolOrchestrator {
	...
	async listTools(signal?: CancellationSignal): Promise<ChatToolDefinition[]> {
		if (!this.isEnabled()) {
			return [];
		}
	 ...
	 */
	private async ensureInitialized(signal?: CancellationSignal): Promise<void> {
	 ...
	 */
	private async performInitialize(signal?: CancellationSignal): Promise<InitializeResult | null> {
